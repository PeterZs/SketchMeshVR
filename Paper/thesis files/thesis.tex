...
\begin{titlepage}
	...
	\includegraphics*[width=0.6\textwidth]{figures/vr_front_img} \\ % TITLE IMAGE - replace by attractive and representative images from your thesis
	\vspace{2cm}
	\sffamily
	\Large
	Floor Verhoeven
...
\includepdf[pages={1}]{declaration-originality2}
\cleardoublepage
%-----------------------------------------------------------------------------------------------
...
\include{ch03-system-description}
\include{ch04-results}
\include{ch05-conclusion}
...
%Enable the following to fill extra pages for printing/binding
%\clearemptydoublepage
%\newpage
%\thispagestyle{empty}
%\mbox{}
