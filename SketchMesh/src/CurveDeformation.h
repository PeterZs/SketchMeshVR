...
public:
	static void startPullCurve(Stroke & _stroke, int handle_ID, int no_total_vertices, Eigen::VectorXi & part_of_original_stroke_);
...
private:
	...
	static Eigen::VectorXi part_of_original_stroke;
