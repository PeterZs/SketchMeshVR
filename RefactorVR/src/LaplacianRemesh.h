...
public:
	...
	static void remesh_open_path(Mesh & m, Stroke& open_path_stroke);
...
private:
	...
	static void update_mesh_values(Mesh & m, Eigen::MatrixXd path, int stroke_ID, int new_mapped_start);
