...
public:
	Patch() : mesh(patch_vertices, patch_faces, new_vertex_boundary_markers, new_edge_boundary_markers, new_vertex_is_fixed, new_mapped_indices, new_sharp_edge, -1) {
...
private:
	...
	void get_patch_vertex(int v_idx, int face, Eigen::MatrixXd & patch_vertices, Eigen::VectorXi & patch_vertex_is_init, Eigen::MatrixXd & V_orig, Eigen::VectorXi & boundary_markers_orig, Eigen::VectorXi & vertex_is_fixed_orig, Eigen::VectorXi & new_mapped_indices_orig, Eigen::VectorXi & mesh_to_patch_indices);

	Eigen::VectorXi parent_vertices, parent_faces, new_vertex_boundary_markers, new_edge_boundary_markers, new_vertex_is_fixed, new_mapped_indices;
